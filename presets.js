...
var presets = {
  ...
  'p1': {mode:"pattern",playing:true,rewind:false,shapeIterations:7,patternSpeed:29,pattern:0,loopTrans:true,curTransitions:[["v-zags","center-circle",0.5],["sine","center-circle",0]],patTileSize:56,patTileScale:2,transLength:0.32,shortRotations:true,rotX:false,rotY:false},
  'p2': {mode:"pattern",playing:true,rewind:false,shapeIterations:7,patternSpeed:19,pattern:0,loopTrans:true,curTransitions:[["birds","diagonal skew",0.5]],patTileSize:56,patTileScale:1,transLength:0.46,shortRotations:true,rotX:false,rotY:false},
  'p3': {mode:"pattern",playing:true,rewind:false,shapeIterations:7,patternSpeed:21,pattern:0,loopTrans:true,curTransitions:[["sine","ltr",0],["birds","rtl",0],["diamonds","cascade down",0],["v-zags","cascade up",0]],patTileSize:47,patTileScale:0.96,transLength:0.04,shortRotations:false,rotX:false,rotY:false},
  'p4': {mode:"pattern",playing:true,rewind:false,shapeIterations:7,patternSpeed:24,pattern:0,curPattern:"h-zags",loopTrans:true,curTransitions:[["herringbone","ltr",0.5],["diamonds","ltr",0]],patTileSize:61,patTileScale:0.86,transLength:0.34,shortRotations:true,rotX:true,rotY:false},
  ...
  'o4': {mode:"orbit",playing:true,rewind:false,shapeIterations:7,orbitSpeed:17,orbit:0.6066579199932566,curl:2,bodies:620,zoom:120,growth:53,camX:1296.9712699158247,camY:-237.67065110214764},
  ...
  'c3': {color1a:"#7999bc",color2a:"#b5ffe8",color1b:"#314c90",color2b:"#fff0cb",c1mode:4,c2mode:4,c1alpha:0.84,c2alpha:0.87,bgColor:"#737e80"},

...
var presets = {
  ...
  'p3': {mode:"pattern",playing:true,rewind:false,shapeIterations:6,patternSpeed:30,pattern:0,curPattern:"icebergs",loopTrans:true,curTransitions:[["birds","center-circle",0.67],["diamonds","center-circle",0.33],["concentric asym","center-circle",0]],patTileSize:44,patTileScale:0.72,transLength:0.22,shortRotations:true,rotX:false,rotY:false},
  'p4': {mode:"pattern",playing:true,rewind:false,shapeIterations:7,patternSpeed:29,pattern:0,loopTrans:true,curTransitions:[["v-zags","center-circle",0.5],["sine","center-circle",0]],patTileSize:56,patTileScale:2,transLength:0.37,shortRotations:true,rotX:false,rotY:false},
  ...
  'o1': {mode:"orbit",playing:true,rewind:false,shapeIterations:7,orbitSpeed:17,orbit:0.6066579199932566,curl:2,bodies:620,zoom:120,growth:53,camX:1296.9712699158247,camY:-237.67065110214764},
  'o2': {mode:"orbit",playing:true,rewind:false,shapeIterations:6,orbitSpeed:36,orbit:8.94785885998085,curl:2,bodies:1740,zoom:6,growth:102,camX:774.9637481340638,camY:329.5700876418172},
  'o3': {mode:"orbit",playing:true,rewind:true,shapeIterations:6,orbitSpeed:13,orbit:-0.17414040000207986,curl:6,bodies:1150,zoom:60,growth:110,camX:15.711408762684869,camY:-109.01611520438132},
  'o4': {mode:"orbit",playing:true,rewind:true,shapeIterations:6,orbitSpeed:3,orbit:3.0024883100007376,curl:17,bodies:1510,zoom:15,growth:101,camX:258.11844328981726,camY:130.69523230436613},
  'o5': {mode:"orbit",playing:true,rewind:false,shapeIterations:6,orbitSpeed:10,orbit:-0.3665538099831863,curl:17,bodies:1170,zoom:29,growth:93,camX:362.9289903603134,camY:190.63129527562057},
  'o6': {mode:"orbit",playing:true,rewind:true,shapeIterations:6,orbitSpeed:40,orbit:5.22760357996852,curl:22,bodies:270,zoom:63,growth:100,camX:22,camY:22},
